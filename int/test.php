...
function test_interpret_or_parser($file, $expected_value, $out, $in, $testType)
{
    ...
    if ($testType == "interpret") {
        ...
        exec("python3.13 " . $interpretpy . " --source=" . $file . " < " . $in . " > " . $temporary_file . " 2> /tmp/IPPtemp", $test_return_int, $test_return_value);
    } else if ($testType == "parser") {

        exec("php8.2 $parsephp < $file", $test_output, $test_return_value);
    }
